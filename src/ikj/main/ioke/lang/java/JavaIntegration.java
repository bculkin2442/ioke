...
public class JavaIntegration {
	public static Class getOrCreate(Class[] types,
	...
	private static boolean hasImplementation(String name,
			ClassRegistry registry) {
		return registry.hasImplementation(name);
	}

	private static Class getImplementationFor(String name,
			ClassRegistry registry) {
		return registry.getImplementation(name);
	}

	private static void createImplementationFor(String name, Class[] types,
			ClassRegistry registry) {
		...
		cw.visitField(0, "__real_ioke_proxy", "Lioke/lang/IokeObject;",
				null, null);
	...
	private static void implementConstructor(ClassWriter cw,
			String className, Class superClass) {
		MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, "<init>",
				"(Lioke/lang/IokeObject;)V", null, null);
		mv.visitCode();
		mv.visitVarInsn(ALOAD, 0);
		mv.visitInsn(DUP);
		mv.visitMethodInsn(INVOKESPECIAL, p(superClass), "<init>", "()V");
		mv.visitVarInsn(ALOAD, 1);
		mv.visitFieldInsn(PUTFIELD, p(className), "__real_ioke_proxy",
				"Lioke/lang/IokeObject;");
		mv.visitInsn(RETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	}

	private static void implementIntegrationMethods(ClassWriter cw,
			String className, Class superClass) {
		MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, "__get_IokeProxy",
				"()Lioke/lang/IokeObject;", null, null);
		mv.visitCode();
		mv.visitVarInsn(ALOAD, 0);
		mv.visitFieldInsn(GETFIELD, p(className), "__real_ioke_proxy",
				"Lioke/lang/IokeObject;");
		mv.visitInsn(ARETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();

		mv = cw.visitMethod(ACC_PUBLIC, "__get_IokeRuntime",
				"()Lioke/lang/Runtime;", null, null);
		mv.visitCode();
		mv.visitVarInsn(ALOAD, 0);
		mv.visitFieldInsn(GETFIELD, p(className), "__real_ioke_proxy",
				"Lioke/lang/IokeObject;");
		mv.visitFieldInsn(GETFIELD, "ioke/lang/IokeObject", "runtime",
				"Lioke/lang/Runtime;");
		mv.visitInsn(ARETURN);
		mv.visitMaxs(1, 1);
		mv.visitEnd();
	...
	private static void implementStubMethodsFor(ClassWriter cw,
	...
	private static void loadParameter(MethodVisitor mv,
			Class parameterType, int position) {
		if (parameterType == Byte.TYPE || parameterType == Integer.TYPE
	...
	private static void loadParameterWithConversion(MethodVisitor mv,
			Class parameterType, int position) {
	...
	private static final String P_JAVA_INVOCATION_HELPER = p(
			JavaInvocationHelper.class);

	private static void implementStubMethod(ClassWriter cw,
			String className, Class type, Method m) {
		// System.err.println("should implement stub method: " + m);
		MethodVisitor mv = cw.visitMethod(ACC_PUBLIC, m.getName(), sig(m),
				null, null);
		...
		if (!type.isInterface()) {
			...
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"hasProxyMethod",
					"(Lioke/lang/java/IokeJavaIntegrated;Ljava/lang/String;)Z");
			...
			mv.visitMethodInsn(INVOKESPECIAL, p(type), m.getName(),
					sig(m));

			if (retType == Void.TYPE) {
				mv.visitInsn(RETURN);
			} else if (retType == Byte.TYPE || retType == Integer.TYPE
					|| retType == Short.TYPE || retType == Character.TYPE
		...
		if (retType == Void.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"voidInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)V");
			mv.visitInsn(RETURN);
		} else if (retType == Byte.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"byteInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)B");
			mv.visitInsn(IRETURN);
		} else if (retType == Integer.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"intInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)I");
			mv.visitInsn(IRETURN);
		} else if (retType == Short.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"shortInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)S");
			mv.visitInsn(IRETURN);
		} else if (retType == Character.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"charInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)C");
			mv.visitInsn(IRETURN);
		} else if (retType == Boolean.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"booleanInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)Z");
			mv.visitInsn(IRETURN);
		} else if (retType == Long.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"longInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)J");
			mv.visitInsn(LRETURN);
		} else if (retType == Float.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"floatInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)F");
			mv.visitInsn(FRETURN);
		} else if (retType == Double.TYPE) {
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"doubleInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;)D");
			mv.visitInsn(DRETURN);
		} else {
			...
			mv.visitMethodInsn(INVOKESTATIC, P_JAVA_INVOCATION_HELPER,
					"objectInvocation",
					"(Lioke/lang/java/IokeJavaIntegrated;[Ljava/lang/Object;Ljava/lang/String;Ljava/lang/Class;)Ljava/lang/Object;");
