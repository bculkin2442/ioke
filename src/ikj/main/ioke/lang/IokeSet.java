...
public class IokeSet extends IokeData {
	...
	public void init(IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(
				runtime.newNativeMethod("returns a hash for the set",
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.set)
					...
					public Object activate(IokeObject self, Object on,
						...
						return ((other instanceof IokeObject)
								&& (IokeObject
										.data(other) instanceof IokeSet)
								&& ((IokeSet) IokeObject.data(on)).set
										.equals(((IokeSet) IokeObject
												.data(other)).set))
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments(
						"withIdentitySemantics!", runtime.set) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							Map<String, Object> keywords,
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("empty?",
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return ((IokeSet) IokeObject.data(on)).getSet()
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("+") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							...
							.whichMustMimic(runtime.set).getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						newSet.addAll(
								((IokeSet) IokeObject.data(args.get(0)))
										.getSet());
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("\u2286") {
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						boolean result = ((IokeSet) IokeObject
								.data(args.get(0))).getSet().containsAll(
										((IokeSet) IokeObject.data(on))
												.getSet());
						return result ? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("\u2282") {
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						Set<Object> one = ((IokeSet) IokeObject
								.data(args.get(0))).getSet();
						Set<Object> two = ((IokeSet) IokeObject.data(on))
								.getSet();
						boolean result = one.containsAll(two);
						return (result && two.size() < one.size())
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("\u2287") {
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						boolean result = ((IokeSet) IokeObject.data(on))
								.getSet().containsAll(((IokeSet) IokeObject
										.data(args.get(0))).getSet());
						return result ? context.runtime._true
								: context.runtime._false;
					}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("each") {
					...
					public Object activate(IokeObject method,
						...
						Object onAsSet = context.runtime.set
								.convertToThis(on, message, context);
						Set<Object> set = ((IokeSet) IokeObject
								.data(onAsSet)).set;
						...
						switch (message.getArgumentCount()) {
							...
							case 1: {
								...
								for (Object o : set) {
									context.runtime.interpreter.evaluate(
											code, context,
