...
/**
 * The Ground serves the same purpose as the Lobby in Self and Io. This is
 * the place where everything is evaluated.
 *
...
public class Ground {
	public static void init(IokeObject iokeGround, IokeObject ground)
		...
		iokeGround.registerCell("DefaultBehavior",
				runtime.defaultBehavior);
		...
		iokeGround.registerMethod(runtime.newNativeMethod(
