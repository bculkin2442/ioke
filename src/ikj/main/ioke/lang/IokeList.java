...
public class IokeList extends IokeData {
	...
	public void init(IokeObject obj) throws ControlFlow {
		...
		obj.mimics(IokeObject
				.as(runtime.mixins.getCell(null, null, "Sequenced"), null),
				runtime.nul, runtime.nul);

		obj.registerMethod(
				runtime.newNativeMethod("returns a hash for the list",
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
					...
					public Object activate(IokeObject self, Object on,
						...
						return (((other instanceof IokeObject)
								&& (IokeObject
										.data(other) instanceof IokeList)
								&& ((IokeList) IokeObject.data(on)).list
										.equals(((IokeList) IokeObject
												.data(other)).list)))
				...
				new TypeCheckingNativeMethod.WithNoArguments("inspect",
					...
					public Object activate(IokeObject method, Object on,
						...
						return method.runtime
								.newText(IokeList.getInspect(on));
					}
				}));
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("notice",
					...
					public Object activate(IokeObject method, Object on,
							...
							throws ControlFlow {
						return method.runtime
								.newText(IokeList.getNotice(on));
					}
				}));

		obj.registerMethod(obj.runtime.newNativeMethod(
				"returns a new sequence to iterate over this list",
				new TypeCheckingNativeMethod.WithNoArguments("seq",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject obj = method.runtime.iteratorSequence
								.allocateCopy(null, null);
						obj.singleMimicsWithoutCheck(
								method.runtime.iteratorSequence);
						obj.setData(new Sequence.IteratorSequence(
								IokeList.getList(on).iterator()));
						return obj;
					}
				}));
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("<=>") {
					...
					public Object activate(IokeObject self, Object on,
						...
						SpaceshipComparator sc = new SpaceshipComparator(
								context, message);
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("each") {
					...
					public Object activate(IokeObject method,
						...
						Object onAsList = context.runtime.list
								.convertToThis(on, message, context);

						List<Object> ls = ((IokeList) IokeObject
								.data(onAsList)).list;
		...
		obj.registerMethod(runtime.newNativeMethod(
				"takes one argument and adds it at the end of the list, and then returns the list",
				new TypeCheckingNativeMethod("append!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
							.withRequiredPositional("value")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("prepend!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
							.withRequiredPositional("value")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("pop!",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						List<Object> l = ((IokeList) IokeObject.data(on))
								.getList();
						if (l.size() == 0) {
							return context.runtime.nil;
						}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("shift!",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("clear!",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("empty?",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("include?") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("concat!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
							.withRequiredPositional("otherList")
							.whichMustMimic(runtime.list).getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						((IokeList) IokeObject.data(on)).getList().addAll(
				...
				new TypeCheckingNativeMethod("+") {
					...
					public Object activate(IokeObject method, Object on,
						...
						newList.addAll(
								((IokeList) IokeObject.data(args.get(0)))
										.getList());
						return context.runtime.newList(newList,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("sort",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						Object newList = IokeObject.mimic(on, message,
								context);
						try {
							Collections.sort(
									((IokeList) IokeObject.data(newList))
											.getList(),
		...
		obj.registerMethod(
				runtime.newNativeMethod("returns the size of this list",
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("at") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
					...
					public Object activate(IokeObject method, Object on,
						...
						if (IokeObject.data(arg) instanceof Range) {
							...
							List<Object> o = ((IokeList) IokeObject
									.data(on)).getList();
							int size = o.size();
						...
						if (!(IokeObject.data(arg) instanceof Number)) {
							arg = IokeObject.convertToNumber(arg, message,
									context);
						}
						int index = ((Number) IokeObject.data(arg))
								.asJavaInteger();
						List<Object> o = ((IokeList) IokeObject.data(on))
								.getList();
						if (index < 0) {
							index = o.size() + index;
						}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("insert!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
							.withRequiredPositional("index")
							.whichMustMimic(runtime.number)
							.withRest("objects").getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						int index = ((Number) IokeObject.data(args.get(0)))
								.asJavaInteger();
						List<Object> l = ((IokeList) IokeObject.data(on))
								.getList();
						int size = l.size();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("remove!") {
					...
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							...
							.withRest("elements").getArguments();
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("compact!",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("reverse!",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("flatten!",
						runtime.list) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("join") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
					...
					public Object activate(IokeObject method, Object on,
						...
						if (list.size() == 0) {
							...
							String sep = args.size() > 0
									? Text.getText(args.get(0)) : "";
							StringBuilder sb = new StringBuilder();
							join(list, sb, sep, context.runtime.asText,
									context);
							result = sb.toString();
						}
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				"Import a java list into this one",
				new TypeCheckingNativeMethod("importList") {

					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.list)
							.withRequiredPositional("list").getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						return context.runtime
								.newList((List<Object>) args.get(0));
					}
				}));
						...
						switch (message.getArgumentCount()) {
							...
							case 2: {
								...
								for (int i = 0; i < size; i++) {
									...
									ls.set(i, runtime.interpreter.evaluate(
											code, c, c.getRealContext(),
											c));
								}
								break;
							}
	...
	private static void flatten(List<Object> list, List<Object> result) {
		for (Object l : list) {
			if (l instanceof IokeObject
					&& IokeObject.data(l) instanceof IokeList) {
	...
	private static void join(List<Object> list, StringBuilder sb,
			String sep, IokeObject asText, IokeObject context)
			throws ControlFlow {
		String realSep = "";
		for (Object o : list) {
			sb.append(realSep);
			if (o instanceof IokeObject
					&& IokeObject.data(o) instanceof IokeList) {
				join(getList(o), sb, sep, asText, context);
			} else {
				sb.append(Text
						.getText(Interpreter.send(asText, context, o)));
			}
			realSep = sep;
		}
	}
