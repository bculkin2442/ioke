...
public class InternalBehavior {
	public static void init(IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("internal:concatenateText") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRest("textSegments")
							.getArguments();
						...
						for (Object o : args) {
							if (o instanceof IokeObject) {
								if (IokeObject.data(o) instanceof Text) {
									...
									sb.append(Text.getText(Interpreter
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("internal:compositeRegexp") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRest("regexpSegments")
							.getArguments();
					...
					private void addRegexp(Object o, StringBuilder sb)
							throws ControlFlow {
						...
						sb.append("(?").append(f).append(nflags)
								.append(":").append(Regexp.getPattern(o))
								.append(")");
					}

					private void addText(Object o, StringBuilder sb)
							throws ControlFlow {
						sb.append(Text.getText(o));
					}

					public void addObject(Object o, StringBuilder sb,
							IokeObject context) throws ControlFlow {
						if (o != null) {
							if (o instanceof String) {
								sb.append(o);
							} else if (IokeObject
									.data(o) instanceof Text) {
								addText(o, sb);
							} else if (IokeObject
									.data(o) instanceof Regexp) {
								addRegexp(o, sb);
							} else {
								addText(Interpreter.send(
					...
					public Object activate(IokeObject method,
						...
						return context.runtime.newRegexp(sb.toString(),
								flags, context, message);
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("internal:createText") {
					...
					public Object activate(IokeObject method,
						...
						if (o instanceof IokeObject) {
							cache = false;
							o = Interpreter.getEvaluatedArgument(o,
									context);
						}
						if (o instanceof String) {
							String s = (String) o;
							Object value = runtime.newText(
									new StringUtils().replaceEscapes(s));
							if (cache) {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("internal:createRegexp") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder()
					...
					public Object activate(IokeObject method,
						...
						if (o2 instanceof IokeObject) {
							o2 = Interpreter.getEvaluatedArgument(o2,
									context);
						}
						if (o instanceof String) {
							String s = (String) o;
							return runtime.newRegexp(
									new StringUtils()
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("internal:createDecimal") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder()
