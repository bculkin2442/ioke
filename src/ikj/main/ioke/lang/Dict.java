...
public class Dict extends IokeData {
	...
	public static IokeObject getDefaultValue(Object on, IokeObject context,
	...
	public void init(IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.dict)
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("withDefault") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.dict)
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						Object newDict = IokeObject.mimic(on, message,
								context);
						setDefaultValue(newDict,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("merge") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.dict)
						...
						for (Object o : args) {
							if (IokeObject.data(o) instanceof Dict) {
								newMap.putAll(getMap(o));
									...
									.data(o) instanceof Pair) {
								newMap.put(Pair.getFirst(o),
										Pair.getSecond(o));
							} else {
								newMap.put(o, context.runtime.nil);
							}
						}
						for (Map.Entry<String, Object> entry : keywords
								.entrySet()) {
							String s = entry.getKey();
							Object key = context.runtime.getSymbol(
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("at") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.dict)
							.withRequiredPositional("key").getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("key?") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.dict)
							.withRequiredPositional("key").getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return (Dict.getMap(on).containsKey(args.get(0)))
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("size",
						runtime.dict) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("keys",
						runtime.dict) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("seq",
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject obj = method.runtime.keyValueIteratorSequence
								.allocateCopy(null, null);
						obj.singleMimicsWithoutCheck(
								method.runtime.keyValueIteratorSequence);
						obj.setData(new Sequence.KeyValueIteratorSequence(
								Dict.getMap(on).entrySet().iterator()));
						return obj;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("each") {
					...
					public Object activate(IokeObject method,
						...
						on = runtime.dict.convertToThis(on, message,
								context);
						...
						switch (message.getArgumentCount()) {
							...
							case 1: {
								...
								for (Map.Entry<Object, Object> o : ls
										.entrySet()) {
									runtime.interpreter.evaluate(code,
											context,
											context.getRealContext(),
											runtime.newPair(o.getKey(),
													o.getValue()));
								}
								break;
							}
							case 2: {
								...
								for (Map.Entry<Object, Object> o : ls
										.entrySet()) {
									c.setCell(name, runtime.newPair(
											o.getKey(), o.getValue()));
	...
	public String inspect(Object obj) throws ControlFlow {
		...
		for (Map.Entry<Object, Object> o : dict.entrySet()) {
			...
			if ((IokeObject.data(key) instanceof Symbol)
					&& Symbol.onlyGoodChars(key)) {
