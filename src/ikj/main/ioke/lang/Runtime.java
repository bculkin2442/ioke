...
public class Runtime extends IokeData {
	...
	public final IokeObject		nul							= new IokeObject(
			this,
			"NOT TO BE EXPOSED TO Ioke - used for internal usage only");
	...
	public IokeRegistry			registry					= new IokeRegistry(
			this);
	public ClassRegistry		classRegistry				= new ClassRegistry(
			this);
	public final Interpreter	interpreter;

	// Core objects and origins
	public IokeObject			base						= new IokeObject(
			this,
	...
	public IokeObject			iokeGround					= new IokeObject(
			this,
			"IokeGround is the place that mimics default behavior, and where most global objects are defined..");
	public IokeObject			ground						= new IokeObject(
			this, "Ground is the default place code is evaluated in.");
	public IokeObject			system						= new IokeObject(
			this,
			"System defines things that represents the currently running system, such as the load path.",
			new IokeSystem());
	public IokeObject			runtime						= new IokeObject(
			this,
			"Runtime gives meta-circular access to the currently executing Ioke runtime.",
			this);
	public IokeObject			defaultBehavior				= new IokeObject(
			this,
			"DefaultBehavior is a mixin that provides most of the methods shared by most instances in the system.");
	public IokeObject			origin						= new IokeObject(
			this,
			"Any object created from scratch should usually be derived from Origin.");
	public IokeObject			nil							= new IokeObject(
			this,
	...
	public IokeObject			_false						= new IokeObject(
			...
			IokeData.False);
	public IokeObject			text						= new IokeObject(
			this, "Contains an immutable piece of text.", new Text(""));
	public IokeObject			symbol						= new IokeObject(
			this,
			"Represents a symbol - an object that always represents itself.",
			new Symbol(""));
	public IokeObject			number						= new IokeObject(
			this, "Represents an exact number",
			new Number(Number.getFrom("0")));
	public IokeObject			method						= new IokeObject(
			this,
			"Method is the origin of all methods in the system, both default and Java..",
			new Method((String) null, IokeData.TYPE_METHOD_PROTOTYPE));
	public IokeObject			defaultMethod				= new IokeObject(
			this,
			"DefaultMethod is the instance all methods in the system are derived from.",
			new DefaultMethod((String) null));
	public IokeObject			nativeMethod				= new IokeObject(
			this,
			"NativeMethod is a derivation of Method that represents a primitive implemented in Java.",
			new NativeMethod.WithNoArguments((String) null));
	public IokeObject			lexicalBlock				= new IokeObject(
			this,
			...
			new LexicalBlock(ground));
	public IokeObject			defaultMacro				= new IokeObject(
			this,
			"DefaultMacro is the instance all non-lexical macros in the system are derived from.",
			new DefaultMacro((String) null));
	public IokeObject			lexicalMacro				= new IokeObject(
			this,
			"LexicalMacro is the instance all lexical macros in the system are derived from.",
			new LexicalMacro((String) null));
	public IokeObject			defaultSyntax				= new IokeObject(
			this,
			"DefaultSyntax is the instance all syntactical macros in the system are derived from.",
			new DefaultSyntax((String) null));
	public IokeObject			arity						= new IokeObject(
			this,
			"Arity provides information about the arguments needed to activate a value.",
			new Arity((DefaultArgumentsDefinition) null));
	public IokeObject			mixins						= new IokeObject(
			this,
			"Mixins is the name space for most mixins in the system. DefaultBehavior is the notable exception.");
	public IokeObject			message						= new IokeObject(
			this, "A Message is the basic code unit in Ioke.",
			new Message(this, ""));
	public IokeObject			restart						= new IokeObject(
			this,
			"A Restart is the actual object that contains restart information.");
	public IokeObject			list						= new IokeObject(
			this, "A list is a collection of objects that can change size",
			new IokeList());
	public IokeObject			dict						= new IokeObject(
			this,
	...
	public IokeObject			call						= new IokeObject(
			...
			new Call());
	public IokeObject			lexicalContext				= new IokeObject(
			this, "A lexical activation context",
			new LexicalContext(ground, ground));
	public IokeObject			dateTime					= new IokeObject(
			this,
			"A DateTime represents the current date and time in a particular time zone.",
			new DateTime(0));

	public IokeObject			locals						= new IokeObject(
			this, "Contains all the locals for a specific invocation.");
	public IokeObject			javaWrapper					= new IokeObject(
			this, "Wraps a java object.", new JavaWrapper());

	public IokeObject			condition					= new IokeObject(
			this, "The root mimic of all the conditions in the system.");
	public IokeObject			rescue						= new IokeObject(
			this,
			"A Rescue contains handling information from rescuing a Condition.");
	public IokeObject			handler						= new IokeObject(
			this,
			"A Handler contains handling information for handling a condition without unwinding the stack.");
	public IokeObject			io							= new IokeObject(
			this, "IO is the base for all input/output in Ioke.",
			new IokeIO());
	public IokeObject			fileSystem					= new IokeObject(
			this, "Gives access to things related to the file system.");

	public IokeObject			regexp						= new IokeObject(
			this,
			"A regular expression allows you to matching text against a pattern.",
			Regexp.create("", ""));

	public IokeObject			javaGround					= new IokeObject(
			this,
			"JavaGround is the place that defines the connections to the Java integration subsystem");

	public IokeObject			javaArray					= new IokeObject(
			this,
			"JavaArray is the common mimic that defines all the magic methods on native java arrays");

	public IokeObject			sequence					= new IokeObject(
			this, "The root mimic of all the sequences in the system.");
	public IokeObject			iteratorSequence			= new IokeObject(
			this,
			"The root mimic of all the iterator sequences in the system.",
			new Sequence.IteratorSequence(
					java.util.Arrays.asList().iterator()));
	public IokeObject			keyValueIteratorSequence	= new IokeObject(
			this,
			"The root mimic of all the key-value-iterator sequences in the system.",
			new Sequence.KeyValueIteratorSequence(
	...
	// Core messages
	public IokeObject			asText						= newMessage(
			"asText");
	public IokeObject			asRational					= newMessage(
			"asRational");
	public IokeObject			asDecimal					= newMessage(
			"asDecimal");
	public IokeObject			asSymbol					= newMessage(
			"asSymbol");
	public IokeObject			asTuple						= newMessage(
			"asTuple");
	public IokeObject			mimic						= newMessage(
			"mimic");
	public IokeObject			spaceShip					= newMessage(
			"<=>");
	public IokeObject			succ						= newMessage(
			"succ");
	public IokeObject			pred						= newMessage(
			"pred");
	public IokeObject			setValue					= newMessage(
			"=");
	public IokeObject			nilMessage					= newMessage(
			"nil");
	public IokeObject			name						= newMessage(
			"name");
	public IokeObject			callMessage					= newMessage(
			"call");
	public IokeObject			closeMessage				= newMessage(
			"close");
	public IokeObject			code						= newMessage(
			"code");
	public IokeObject			each						= newMessage(
			"each");
	public IokeObject			textMessage					= newMessage(
			"text");
	public IokeObject			conditionsMessage			= newMessage(
			"conditions");
	public IokeObject			handlerMessage				= newMessage(
			"handler");
	public IokeObject			reportMessage				= newMessage(
			"report");
	public IokeObject			printMessage				= newMessage(
			"print");
	public IokeObject			printlnMessage				= newMessage(
			"println");
	public IokeObject			outMessage					= newMessage(
			"out");
	public IokeObject			currentDebuggerMessage		= newMessage(
			"currentDebugger");
	public IokeObject			invokeMessage				= newMessage(
			"invoke");
	public IokeObject			errorMessage				= newMessage(
			"error!");
	public IokeObject			ErrorMessage				= newMessage(
			"Error");
	public IokeObject			FileMessage					= newMessage(
			"File");
	public IokeObject			inspectMessage				= newMessage(
			"inspect");
	public IokeObject			noticeMessage				= newMessage(
			"notice");

	public IokeObject			removeCellMessage			= newMessage(
			"removeCell!");
	...
	public IokeObject			testMessage					= newMessage(
			"test");

	public IokeObject			isApplicableMessage			= newMessage(
			"applicable?");

	public IokeObject			coerceIntoJavaCodeMessage	= newMessage(
			"java:coerceCode");

	public IokeObject			useWhatMessage				= newMessage(
			"UseWhat");

	public IokeObject			cellAddedMessage			= newMessage(
			"cellAdded");
	public IokeObject			cellChangedMessage			= newMessage(
			"cellChanged");
	public IokeObject			cellRemovedMessage			= newMessage(
			"cellRemoved");
	public IokeObject			cellUndefinedMessage		= newMessage(
			"cellUndefined");
	public IokeObject			mimicAddedMessage			= newMessage(
			"mimicAdded");
	public IokeObject			mimicRemovedMessage			= newMessage(
			"mimicRemoved");
	public IokeObject			mimicsChangedMessage		= newMessage(
			"mimicsChanged");
	public IokeObject			mimickedMessage				= newMessage(
			"mimicked");
	public IokeObject			seqMessage					= newMessage(
			"seq");
	public IokeObject			hashMessage					= newMessage(
			"hash");
	public IokeObject			nextPMessage				= newMessage(
			"next?");
	public IokeObject			nextMessage					= newMessage(
			"next");
	public IokeObject			kindMessage					= newMessage(
			"kind");

	public Runtime() throws Exception {
		this(new PrintWriter(
				new OutputStreamWriter(java.lang.System.out, "UTF-8")),
				new InputStreamReader(java.lang.System.in, "UTF-8"),
				new PrintWriter(new OutputStreamWriter(
						java.lang.System.err, "UTF-8")),
				new Interpreter());
	}
	...
	public static Runtime getRuntime() throws ControlFlow, Exception {
		return getRuntime(new PrintWriter(java.lang.System.out),
				new InputStreamReader(java.lang.System.in, "UTF-8"),
				new PrintWriter(java.lang.System.err));
	}

	public static Runtime getRuntime(PrintWriter out, Reader in,
			PrintWriter err) throws ControlFlow {
	...
	public String getCurrentWorkingDirectory() {
		return ((IokeSystem) IokeObject.data(system))
	...
	public void init() throws ControlFlow {
		...
		try {
			evaluateString(
					"System lowLevelLoad!(\"builtin/A01_use\", false)",
					message, ground);
			evaluateString("use(\"builtin/A05_conditions\")", message,
					ground);
			evaluateString("use(\"builtin/A10_defaultBehavior\")", message,
					ground);
			evaluateString("use(\"builtin/A15_dmacro\")", message, ground);
			evaluateString("use(\"builtin/A20_comparing\")", message,
					ground);
			evaluateString(
					"use(\"builtin/A25_defaultBehavior_inspection\")",
					message, ground);
			...
			evaluateString("use(\"builtin/D20_booleans\")", message,
					ground);
			...
			evaluateString("use(\"builtin/D45_fileSystem\")", message,
					ground);

			evaluateString("use(\"builtin/F05_case\")", message, ground);
			evaluateString("use(\"builtin/F10_comprehensions\")", message,
					ground);
			evaluateString("use(\"builtin/F15_message\")", message,
					ground);
			evaluateString("use(\"builtin/F20_set\")", message, ground);
			evaluateString("use(\"builtin/F25_cond\")", message, ground);
			evaluateString("use(\"builtin/F30_enumerable\")", message,
					ground);
			evaluateString("use(\"builtin/F32_sequence\")", message,
					ground);

			evaluateString("use(\"builtin/G05_aspects\")", message,
					ground);
			...
			evaluateString("use(\"builtin/H10_lexicalBlock\")", message,
					ground);
			evaluateString("use(\"builtin/H50_struct\")", message, ground);

			evaluateString("use(\"builtin/M05_ignoreErrors\")", message,
					ground);
			evaluateString("use(\"builtin/O05_misc\")", message, ground);

			evaluateString("use(\"builtin/J05_javaGround\")", message,
					ground);
	...
	public IokeObject parseStream(Reader reader, IokeObject message,
			IokeObject context) throws ControlFlow {
		return Message.newFromStream(this, reader, message, context);
	}

	public Object evaluateStream(Reader reader, IokeObject message,
			IokeObject context) throws ControlFlow {
	...
	public Object evaluateString(String str, IokeObject message,
			IokeObject context) throws ControlFlow {
		IokeObject msg = parseStream(new StringReader(str), message,
				context);
		if (msg != null) {
			return interpreter.evaluate(msg, ground, ground, ground);
		} else {
	...
	public Object evaluateStream(String name, Reader reader,
			IokeObject message, IokeObject context) throws ControlFlow {
		try {
	...
	public Object evaluateFile(File f, IokeObject message,
		...
		try {
			((IokeSystem) IokeObject.data(system))
					.pushCurrentFile(f.getCanonicalPath());
	...
	public void reportNativeException(Exception e, IokeObject message,
			IokeObject context) throws ControlFlow {
		final IokeObject condition = IokeObject
				.as(IokeObject.getCellChain(this.condition, message,
						context, "Error", "NativeException"), context)
				.mimic(message, context);
		condition.setCell("message", message);
		condition.setCell("context", context);
		condition.setCell("receiver", context);
		condition.setCell("rootException", e);
		condition.setCell("exceptionType",
				newText(e.getClass().getName()));
	...
	public IokeObject newLexicalContext(Object ground,
			String documentation, IokeObject surroundingContext) {
	...
	public IokeObject newRegexp(String pattern, String flags,
	...
	public IokeObject createJavaWrapper(Object object) {
		if (object instanceof Class) {
			if (object == Object.class) {
				...
				obj.setData(JavaWrapper.wrapWithMethods((Class) object,
						obj, this));
				return obj;
	...
	public IokeObject createIntegratedJavaWrapper(Class clz) {
		...
		obj.setData(
				JavaIntegrationWrapper.wrapWithMethods(clz, obj, this));
		return obj;
	}

	public IokeObject createJavaMethod(java.lang.reflect.Method[] methods)
			throws ControlFlow {
		return newMethod(null, this.nativeMethod,
				new JavaMethodNativeMethod(methods));
	}

	public IokeObject createJavaMethod(
			java.lang.reflect.Constructor[] ctors, boolean special)
			throws ControlFlow {
		return newMethod(null, this.nativeMethod,
				new JavaConstructorNativeMethod(ctors, special));
	}

	public IokeObject createJavaFieldGetter(java.lang.reflect.Field field)
			throws ControlFlow {
		return newMethod(null, this.nativeMethod,
				new JavaFieldGetterNativeMethod(field));
	}

	public IokeObject createJavaFieldSetter(java.lang.reflect.Field field)
			throws ControlFlow {
		return newMethod(null, this.nativeMethod,
				new JavaFieldSetterNativeMethod(field));
	}
	...
	public IokeObject newMessageFrom(IokeObject m, String name,
			List<Object> args) throws ControlFlow {
	...
	public IokeObject newLexicalBlock(String doc, IokeObject tp,
			LexicalBlock impl) throws ControlFlow {
		IokeObject obj = tp.allocateCopy(null, null);
		obj.setDocumentation(doc, null, null);
		obj.singleMimicsWithoutCheck(tp);
		obj.setData(impl);
	...
	public void errorCondition(IokeObject cond) throws ControlFlow {
		Interpreter.send(errorMessage, ground, ground,
				createMessage(Message.wrap(cond)));
	}
	...
	public IokeObject newCallFrom(IokeObject ctx, IokeObject message,
	...
	public IokeObject newRange(IokeObject from, IokeObject to,
			boolean inclusive, boolean inverted) {
	...
	public IokeObject newFile(IokeObject context, File eff)
			throws ControlFlow {
		IokeObject fileMimic = IokeObject.as(
				Interpreter.send(FileMessage, context, this.fileSystem),
				context);
	...
	public Object withRestartReturningArguments(
		...
		for (Restart.JavaRestart rjr : restarts) {
			IokeObject rr = IokeObject.as(
					Interpreter.send(mimic, context, restart), context);
			...
			if (report != null) {
				IokeObject.setCell(rr, "report",
						evaluateString("fn(r, \"" + report + "\")",
								message, ground),
						context);
			}

			rrs.add(0,
					new RestartInfo(rjr.getName(), rr, rrs, index, rjr));
			index = index.nextCol();
		}
		...
		try {
			...
			if ((ri = e.getRestart()).token == rrs) {
				...
				IokeObject result = currentRjr.invoke(context,
						e.getArguments());
				return result;
			} else {
				throw e;
	...
	public void withReturningRestart(String name, IokeObject context,
			RunnableWithControlFlow code) throws ControlFlow {
	...
	public Object withReturningRescue(IokeObject context, Object toReturn,
			RunnableWithReturnAndControlFlow javaRescue)
			throws ControlFlow {
		List<RescueInfo> rescues = new ArrayList<>();
		IokeObject rr = IokeObject
				.as(Interpreter.send(mimic, context, rescue), context);
	...
	public static class RescueInfo {
		...
		public RescueInfo(IokeObject rescue,
				List<Object> applicableConditions, Object token,
				BindIndex index) {
			this.rescue = rescue;
	...
	public static class HandlerInfo {
		...
		public HandlerInfo(IokeObject handler,
				List<Object> applicableConditions, Object token,
				BindIndex index) {
		...
		for (List<HandlerInfo> lrp : handlers.get()) {
			for (HandlerInfo rp : lrp) {
				...
				for (Object possibleKind : rp.applicableConditions) {
					if (IokeObject.isMimic(condition,
							IokeObject.as(possibleKind, condition))) {
						result.add(rp);
					}
				}
			}
	...
	public void tearDown() throws ControlFlow.Exit {
		int status = 0;
		List<IokeSystem.AtExitInfo> atExits = IokeSystem
				.getAtExits(system);
		while (!atExits.isEmpty()) {
			IokeSystem.AtExitInfo atExit = atExits.remove(0);
			try {
				interpreter.evaluate(atExit.message, atExit.context,
						atExit.context.getRealContext(), atExit.context);
			} catch (ControlFlow.Exit e) {
				status = 1;
			} catch (ControlFlow e) {
				String name = e.getClass().getName();
				System.err.println("unexpected control flow: " + name
						.substring(name.indexOf("$") + 1).toLowerCase());
				if (debug) {
	...
	public void afterInitRuntime(IokeObject obj) throws ControlFlow {
		try {
			...
			props.load(Main.class
					.getResourceAsStream("/ioke/lang/version.properties"));

			String version = props.getProperty("ioke.build.version");
			String runtimeVersion = props
					.getProperty("ioke.build.runtimeVersion");
			String versionString = props
					.getProperty("ioke.build.versionString");
	...
	public static void initRuntime(IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("nodeId",
						obj) {
					@Override
		...
		obj.registerMethod(obj.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("create",
						obj) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						Runtime r = new Runtime(method.runtime.out,
								method.runtime.in, method.runtime.err);
						r.init();
						IokeObject o = method.runtime.runtime
								.allocateCopy(null, null);
