...
public class Reflector {
	public static void init(final Runtime runtime) throws ControlFlow {
		IokeObject obj = new IokeObject(runtime,
				"Allows access to the internals of any object without actually using methods on that object");
		...
		obj.registerMethod(runtime.newNativeMethod(
				"returns the documentation text of the object given as argument. anything can have a documentation text - this text will initially be nil.",
				new TypeCheckingNativeMethod("other:documentation") {
					...
					public Object activate(IokeObject method, Object on,
							...
							throws ControlFlow {
						return Base.documentation(context, message,
								args.get(0));
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:documentation=") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							...
							.whichMustMimic(runtime.text).orBeNil()
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return Base.setDocumentation(context, message,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:kind?") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
					...
					public Object activate(IokeObject method, Object on,
						...
						return IokeObject.isKind(args.get(0), kind,
								context) ? context.runtime._true
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:mimics?") {
					...
					public Object activate(IokeObject method,
						...
						return IokeObject.isMimic(args.get(0),
								IokeObject.as(args.get(1), context),
								context) ? context.runtime._true
										: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				"Takes one evaluated argument and returns either true or false if this object or one of it's mimics mimics that argument. exactly the same as 'other:mimics?'",
				new NativeMethod("other:is?") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
							.withRequiredPositional("potentialMimic")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						IokeObject arg = IokeObject.as(args.get(1),
								context);
						return IokeObject.isMimic(args.get(0), arg,
								context) ? context.runtime._true
										: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:mimics") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						return context.runtime
								.newList(new ArrayList<Object>(IokeObject
										.getMimics(args.get(0), context)));
					}
				}));

		obj.registerMethod(runtime.newNativeMethod(
				"removes all mimics on the receiver, and returns the receiver",
				new TypeCheckingNativeMethod("other:removeAllMimics!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject.removeAllMimics(args.get(0), message,
								context);
						return args.get(0);
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:removeMimic!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
					...
					public Object activate(IokeObject method,
						...
						IokeObject.removeMimic(args.get(0), args.get(1),
								message, context);
						return args.get(0);
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:mimic!") {
					...
					public Object activate(IokeObject method,
						...
						IokeObject newMimic = IokeObject.as(args.get(1),
								context);
						IokeObject.as(args.get(0), context)
								.mimics(newMimic, message, context);
						return args.get(0);
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:prependMimic!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
							.withRequiredPositional("newMimic")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						IokeObject newMimic = IokeObject.as(args.get(1),
								context);
						IokeObject.as(args.get(0), context).mimics(0,
								newMimic, message, context);
						return args.get(0);
					}
				}));
					...
					public Object activate(IokeObject method,
						...
						String name = Text.getText(
								Interpreter.send(context.runtime.asText,
										context, args.get(1)));
						return IokeObject.getCell(args.get(0), message,
								context, name);
					}
				}));
				...
				new NativeMethod("other:cell?") {
					...
					public Object activate(IokeObject method,
						...
						String name = Text.getText(
								Interpreter.send(context.runtime.asText,
										context, args.get(1)));
						return IokeObject.findCell(args.get(0), context,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:cellOwner?") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
							.withRequiredPositional("cellName")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						String name = Text.getText(
								Interpreter.send(context.runtime.asText,
										context, args.get(1)));
						return (IokeObject.findPlace(args.get(0), message,
								context, name) == args.get(0))
										? context.runtime._true
										: context.runtime._false;
					}
				}));
				...
				new NativeMethod("other:cellOwner") {
					...
					public Object activate(IokeObject method,
						...
						String name = Text.getText(
								Interpreter.send(context.runtime.asText,
										context, args.get(1)));
						Object result = IokeObject.findPlace(args.get(0),
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:removeCell!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
							.withRequiredPositional("cellName")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						String name = Text.getText(
								Interpreter.send(context.runtime.asText,
										context, args.get(1)));
						IokeObject.removeCell(args.get(0), message,
								context, name);
						return args.get(0);
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:undefineCell!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
							.withRequiredPositional("cellName")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						String name = Text.getText(
								Interpreter.send(context.runtime.asText,
										context, args.get(1)));
						IokeObject.undefineCell(args.get(0), message,
								context, name);
						return args.get(0);
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:cellNames") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("other")
					...
					public Object activate(IokeObject method,
						...
						return Base.cellNames(context, message,
								args.get(0),
								args.size() > 1
										&& IokeObject.isTrue(args.get(1)),
				...
				new NativeMethod("other:cells") {
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						return Base.cells(context, message, args.get(0),
								args.size() > 1
										&& IokeObject.isTrue(args.get(1)));
					}
				}));
				...
				new NativeMethod("other:cell=") {
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						return Base.assignCell(context, message,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:mimic") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
				...
				new NativeMethod("other:become!") {
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						IokeObject me = IokeObject.as(args.get(0),
								context);
						IokeObject other = IokeObject.as(args.get(1),
								context);

						if (args.get(0) == context.runtime.nil
								|| args.get(0) == context.runtime._true
								|| args.get(0) == context.runtime._false) {
							final IokeObject condition = IokeObject
									.as(IokeObject.getCellChain(
											context.runtime.condition,
											message, context, "Error",
											"CantMimicOddball"), context)
									.mimic(message, context);
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:frozen?") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return IokeObject.isFrozen(args.get(0))
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:freeze!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:thaw!") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("other:uniqueHexId") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("other")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:same?") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("this")
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						return IokeObject.same(args.get(0), args.get(1))
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("other:send") {
					...
					public Object activate(IokeObject method,
						...
						Object recv = Interpreter
								.getEvaluatedArgument(message, 0, context);
						Object _name = Interpreter
								.getEvaluatedArgument(message, 1, context);
						String name = Text.getText(Interpreter
								.send(runtime.asText, context, _name));
