...
public class Tuple extends IokeData {
	...
	public void init(IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("private:initializeWith") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRest("values").getArguments();
					...
					public Object activate(IokeObject method,
						...
						IokeObject.as(on, context)
								.setData(new Tuple(args.toArray(o)));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("private:accessor") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						final int index = Number.extractInt(args.get(0),
								message, context);
						return runtime.newNativeMethod(
								"Returns the object at index " + index
										+ " in the receiving tuple",
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.tuple)
					...
					public Object activate(IokeObject self, Object on,
						...
						if ((other instanceof IokeObject) && (IokeObject
								.data(other) instanceof Tuple)) {
							Tuple d2 = (Tuple) IokeObject.data(other);
							int len = d.elements.length;
							if (len == d2.elements.length) {
								for (int i = 0; i < len; i++) {
									if (!d.elements[i]
											.equals(d2.elements[i])) {
										notResult = true;
										break;
									}
								}
						...
						return !notResult ? context.runtime._true
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("<=>") {
					...
					public Object activate(IokeObject self, Object on,
						...
						Object[] one = ((Tuple) IokeObject
								.data(on)).elements;
						Object[] two = ((Tuple) IokeObject
								.data(arg)).elements;
		...
		obj.registerMethod(
				runtime.newNativeMethod("Returns the arity of this tuple",
