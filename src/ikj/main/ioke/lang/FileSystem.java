...
public class FileSystem {
	public static List<String> glob(Runtime runtime, String text) {
		return Dir.push_glob(runtime.getCurrentWorkingDirectory(), text,
				0);
	}
	...
	public static class IokeFile extends IokeIO {
		...
		public void init(IokeObject obj) throws ControlFlow {
			...
			obj.registerMethod(runtime.newNativeMethod(
					"Closes any open stream to this file",
					new TypeCheckingNativeMethod.WithNoArguments("close",
							obj) {
						@Override
	...
	public static void init(IokeObject obj) throws ControlFlow {
		...
		IokeObject file = new IokeObject(runtime,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("[]") {
					...
					public Object activate(IokeObject method,
						...
						List<String> dirs = FileSystem.glob(
								context.runtime,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("directory?") {
					...
					public Object activate(IokeObject method,
						...
						String name = IokeSystem.withReplacedHomeDirectory(
								Text.getText(args.get(0)));
						File f = null;
						...
						return f.isDirectory() ? context.runtime._true
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("readFully") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("fileName")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("file?") {
					...
					public Object activate(IokeObject method,
						...
						return f.isFile() ? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("exists?") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("entryName")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						return f.exists() ? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				"Takes a file name and a lexical block - opens the file, ensures that it exists and then yields the file to the block. Finally it closes the file after the block has finished executing, and then returns the result of the block.",
				new NativeMethod("withOpenFile") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("fileName")
							.withRequiredPositional("code").getArguments();
					...
					public Object activate(IokeObject method,
						...
						IokeObject ff = context.runtime.newFile(context,
								f);
						Object result = context.runtime.nil;

						try {
							result = Interpreter.send(
									context.runtime.callMessage, context,
									args.get(1), ff);
						} finally {
							Interpreter.send(context.runtime.closeMessage,
									context, ff);
						}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("createDirectory!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder()
							.withRequiredPositional("directoryName")
					...
					public Object activate(IokeObject method,
						...
						if (f.exists()) {
							String msg = null;
							if (f.isFile()) {
								msg = "Can't create directory '" + name
										+ "' since there already exists a file with that name";
							} else {
								msg = "Can't create directory '" + name
										+ "' since there already exists a directory with that name";
							}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("removeDirectory!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder()
							.withRequiredPositional("directoryName")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						if (!f.exists() || f.isFile()) {
							String msg = null;
							if (f.isFile()) {
								msg = "Can't remove directory '" + name
										+ "' since it is a file";
							} else {
								msg = "Can't remove directory '" + name
