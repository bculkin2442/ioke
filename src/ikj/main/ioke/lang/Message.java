...
public class Message extends IokeData {
	...
	public Message(Runtime runtime, String name, Object arg1,
		...
		this.file = ((IokeSystem) IokeObject.data(runtime.system))
				.currentFile();
	...
	public static Message wrap(String name, Object cachedResult,
			Runtime runtime) {
	...
	public static void setIsTerminator(Object message,
			boolean isTerminator) {
	...
	public static String getStackTraceText(Object _message)
		...
		while (prev(start) != null
				&& prev(start).getLine() == message.getLine()) {
			start = prev(start);
		}
	...
	public void init(final IokeObject message) throws ControlFlow {
		...
		message.mimics(
				IokeObject.as(message.runtime.mixins.getCell(null, null,
						"Enumerable"), null),
				message.runtime.nul, message.runtime.nul);

		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("code",
					...
					public Object activate(IokeObject method, Object on,
						...
						return method.runtime.newText(
								((Message) IokeObject.data(on)).code());
					}
				}));
				...
				new TypeCheckingNativeMethod.WithNoArguments("arguments",
					...
					public Object activate(IokeObject method, Object on,
						...
						return context.runtime.newList(
								((Message) IokeObject.data(on)).arguments);
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments(
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return method.runtime.newText(Message
								.formattedCode(IokeObject.as(on, context),
										0, context));
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("name",
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return method.runtime.getSymbol(
								((Message) IokeObject.data(on)).name);
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new NativeMethod("walk") {
					...
					public Object activate(IokeObject method,
						...
						Object onAsMessage = context.runtime.message
								.convertToThis(on, message, context);

						switch (message.getArgumentCount()) {
							case 1: {
								IokeObject code = IokeObject.as(
										message.getArguments().get(0),
										context);
								walkWithReceiver(context, onAsMessage,
										code);

								break;
							}
							case 2: {
								IokeObject c = context.runtime
										.newLexicalContext(context,
												"Lexical activation context for Set#each",
												context);
								String name = IokeObject
										.as(message.getArguments().get(0),
												context)
										.getName();
								IokeObject code = IokeObject.as(
										message.getArguments().get(1),
										context);

								walkWithoutExplicitReceiver(onAsMessage, c,
										name, code);
								break;
							}
						}
					...
					private void walkWithoutExplicitReceiver(
							Object onAsMessage, IokeObject c, String name,
							IokeObject code) throws ControlFlow {
						Object o = onAsMessage;
						while (o != null) {
							c.setCell(name, o);
							code.runtime.interpreter.evaluate(code, c,
									c.getRealContext(), c);
							for (Object arg : ((IokeObject) o)
									.getArguments()) {
								walkWithoutExplicitReceiver(arg, c, name,
										code);
							}
							o = next(o);
						}
					...
					private void walkWithReceiver(IokeObject context,
							Object onAsMessage, IokeObject code)
							throws ControlFlow {
						Object o = onAsMessage;
						while (o != null) {
							code.runtime.interpreter.evaluate(code,
									context, context.getRealContext(), o);
							for (Object arg : ((IokeObject) o)
									.getArguments()) {
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new NativeMethod("each") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder()
							.withOptionalPositionalUnevaluated(
									"indexOrArgOrCode")
							.withOptionalPositionalUnevaluated("argOrCode")
							.withOptionalPositionalUnevaluated("code")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						switch (message.getArgumentCount()) {
							case 0: {
								return Interpreter.send(runtime.seqMessage,
										context, on);
							}
							case 1: {
								IokeObject code = IokeObject.as(
								...
								Object o = onAsMessage;
								while (o != null) {
									runtime.interpreter.evaluate(code,
											context,
											context.getRealContext(), o);
									o = next(o);
								}
							...
							case 2: {
								...
								while (o != null) {
									c.setCell(name, o);
									runtime.interpreter.evaluate(code, c,
											c.getRealContext(), c);
									o = next(o);
								}
								break;
							...
							case 3: {
								IokeObject c = context.runtime
										.newLexicalContext(context,
												"Lexical activation context for Set#each",
												context);
								String iname = IokeObject
										.as(message.getArguments().get(0),
												context)
										.getName();
								String name = IokeObject
										.as(message.getArguments().get(1),
												context)
										.getName();
								IokeObject code = IokeObject.as(
										message.getArguments().get(2),
										context);
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("name=") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(message)
					...
					public Object activate(IokeObject method, Object on,
						...
						if (IokeObject.data(o) instanceof Symbol) {
							...
							name = Text.getText(IokeObject.convertToText(o,
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("next=") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(message)
					...
					public Object activate(IokeObject method, Object on,
						...
						if (o == context.runtime.nil) {
							Message.setNext(IokeObject.as(on, context),
									null);
						} else {
							o = context.runtime.message.convertToThis(o,
									message, context);
							Message.setNext(IokeObject.as(on, context),
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("prev=") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(message)
					...
					public Object activate(IokeObject method, Object on,
						...
						Object o = args.get(0);
						if (o == context.runtime.nil) {
							Message.setPrev(IokeObject.as(on, context),
									null);
						} else {
							o = context.runtime.message.convertToThis(o,
									message, context);
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("filename",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							throws ControlFlow {
						return method.runtime.newText(
								((Message) IokeObject.data(on)).file);
					}
				}));

		message.registerMethod(message.runtime.newNativeMethod(
				"returns the line where this message is written",
				new TypeCheckingNativeMethod.WithNoArguments("line",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return method.runtime.newNumber(
								((Message) IokeObject.data(on)).line);
					}
				}));

		message.registerMethod(message.runtime.newNativeMethod(
				"returns the position on the line where this message is written",
				new TypeCheckingNativeMethod.WithNoArguments("position",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							throws ControlFlow {
						return method.runtime.newNumber(
								((Message) IokeObject.data(on)).pos);
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("next",
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject next = ((Message) IokeObject
								.data(on)).next;
						if (next == null) {
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("last",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("prev",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject prev = ((Message) IokeObject
								.data(on)).prev;
						if (prev == null) {
							return context.runtime.nil;
						} else {
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("terminator?",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return Message.isTerminator(on)
				...
				new TypeCheckingNativeMethod.WithNoArguments(
					...
					public Object activate(IokeObject method, Object on,
						...
						return context.runtime
								.newText(Message.getStackTraceText(on));
					}
				}));

		message.registerMethod(message.runtime.newNativeMethod(
				"returns a deep clone of this message chain, starting at the current point.",
				new TypeCheckingNativeMethod.WithNoArguments("deepCopy",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("keyword?",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return ((Message) IokeObject.data(on)).isKeyword()
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("symbol?",
						message) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return ((Message) IokeObject.data(on)).isSymbol()
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new NativeMethod("sendTo") {
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject realReceiver = IokeObject
								.as(args.get(0), context);
						...
						return Interpreter.send(msg, realContext,
								realReceiver);
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new NativeMethod("appendArgument") {
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject.as(on, context).getArguments()
								.add(args.get(0));
						return on;
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new NativeMethod(">>") {
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject.as(on, context).getArguments().add(0,
								args.get(0));
						return on;
					}
				}));
				...
				new TypeCheckingNativeMethod("->") {
					...
					public Object activate(IokeObject method, Object on,
						...
						if (arg == context.runtime.nil) {
							...
							arg = context.runtime.message
									.convertToThis(arg, message, context);
							Message.setNext(IokeObject.as(on, context),
									IokeObject.as(arg, context));
							Message.setPrev(IokeObject.as(arg, context),
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("arguments=") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(message)
					...
					public Object activate(IokeObject method, Object on,
						...
						if (arg == context.runtime.nil) {
							// no arguments for this message
								...
								.data(arg) instanceof IokeList) {
							List<Object> elements = IokeList.getList(arg);
							IokeObject.as(on, method).getArguments()
									.addAll(elements);
						} else {
							IokeObject.as(on, method).getArguments().add(0,
									arg);
						}
						return on;
					}
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new NativeMethod("evaluateOn") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("ground")
							.withOptionalPositional("receiver", "ground")
							.withRest("arguments").getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						IokeObject messageGround = IokeObject
								.as(args.get(0), context);
						...
						if (size > 1) {
							...
							if (size > 2) {
								IokeObject m = IokeObject.as(on, context)
										.allocateCopy(
												IokeObject.as(on, context),
												context);
								m.getArguments().clear();
								m.getArguments()
										.addAll(args.subList(2, size));
								on = m;
							}
						}
						IokeObject msg = IokeObject.as(on, context);
						return context.runtime.interpreter.evaluate(msg,
								messageGround, messageGround, receiver);
					}
				}));

		message.registerMethod(message.runtime.newNativeMethod(
				"takes one index, and a context and returns the evaluated argument at that index.",
				new NativeMethod("evalArgAt") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder()
					...
					public Object activate(IokeObject method, Object on,
							...
							final IokeObject message) throws ControlFlow {
						int index = Number.extractInt(args.get(0), message,
								context);
						...
						while (index < 0 || index >= argCount) {
							...
							condition.setCell("index",
									context.runtime.newNumber(index));
						...
						return Interpreter.getEvaluatedArgument(_m, index,
								newContext);
					}
				}));
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("fromText") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("code")
							.whichMustMimic(message.runtime.text)
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						return Message.newFromStream(context.runtime,
								new StringReader(code), message, context);
					}
				}));

		message.registerMethod(message.runtime.newNativeMethod(
				"Takes one evaluated argument and returns a message that wraps the value of that argument.",
				new NativeMethod("wrap") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("value")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						return context.runtime.createMessage(Message.wrap(
		...
		message.registerMethod(message.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("doText") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().withRequiredPositional("code")
							.whichMustMimic(message.runtime.text)
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							throws ControlFlow {
						String code = Text.getText(args.get(0));
						return context.runtime.evaluateString(code,
								message, context);
					}
				}));
	}
	...
	public static void setArguments(IokeObject message,
			List<Object> arguments) {
	...
	public static boolean isKeyword(Object message) {
		if ((message instanceof IokeObject)
				&& (IokeObject.data(message) instanceof Message)) {
	...
	public static int line(Object message, IokeObject ctx)
			throws ControlFlow {
	...
	public static IokeObject newFromStream(Runtime runtime, Reader reader,
			IokeObject message, IokeObject context) throws ControlFlow {
		try {
			IokeParser parser = new IokeParser(runtime, reader, context,
					message);
	...
	public static String formattedCode(IokeObject message, int indent,
	...
	private void currentCode(StringBuilder base) {
		if (this.name.equals("internal:createText")
				&& (this.arguments.size() > 0
						&& this.arguments.get(0) instanceof String)) {
			base.append('"').append(this.arguments.get(0)).append('"');
		} else if (this.name.equals("internal:createRegexp")
				&& (this.arguments.size() > 0
						&& this.arguments.get(0) instanceof String)) {
			base.append("#/").append(this.arguments.get(0)).append('/')
					.append(this.arguments.get(1));
		} else if (this.name.equals("internal:createNumber")
				&& (this.arguments.size() > 0
						&& this.arguments.get(0) instanceof String)) {
			base.append(this.arguments.get(0));
		} else if (this.name.equals("internal:createDecimal")
				&& (this.arguments.size() > 0
						&& this.arguments.get(0) instanceof String)) {
			base.append(this.arguments.get(0));
			...
			if (arguments.size() > 0 || this.name.length() == 0) {
				...
				for (Object o : arguments) {
					if (!(o instanceof IokeObject)
							|| !(IokeObject.data(o) instanceof Message)) {
						base.append(sep).append(o);
					} else {
						base.append(sep)
								.append(Message.code((IokeObject) o));
					}
	...
	private void currentFormattedCode(StringBuilder base, int indent,
			IokeObject ctx) throws ControlFlow {
		if (this.name.equals("internal:createText")
				&& (this.arguments.size() > 0
						&& this.arguments.get(0) instanceof String)) {
			...
			for (int i = 0; i < this.arguments.size(); i++) {
				...
				if (Message.name(arg).equals("internal:createText")
						&& (Message.arguments(arg).size() > 0
								&& Message.arguments(arg)
										.get(0) instanceof String)) {
					base.append(Message.arguments(arg).get(0));
				} else {
					base.append("#{");
					base.append(Message.formattedCode(
							IokeObject.as(arg, ctx), 0, ctx));
					base.append("}");
				}
			}
			base.append('"');
			...
			base.append(" = ");
			base.append(Message.formattedCode(
					IokeObject.as(this.arguments.get(1), ctx), indent + 2,
					ctx));
		} else if (this.isTerminator) {
			base.append("\n");
