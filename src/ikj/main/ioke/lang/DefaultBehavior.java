...
public class DefaultBehavior {
	public static void init(IokeObject obj) throws ControlFlow {
		...
		IokeObject baseBehavior = new IokeObject(runtime,
				"contains behavior copied from Base");
		...
		baseBehavior.setCell("cellNames",
				runtime.base.body.get("cellNames"));
		baseBehavior.setCell("removeCell!",
				runtime.base.body.get("removeCell!"));
		baseBehavior.setCell("undefineCell!",
				runtime.base.body.get("undefineCell!"));
		baseBehavior.setCell("cellOwner?",
				runtime.base.body.get("cellOwner?"));
		baseBehavior.setCell("cellOwner",
				runtime.base.body.get("cellOwner"));
		baseBehavior.setCell("documentation",
				runtime.base.body.get("documentation"));
		baseBehavior.setCell("identity",
				runtime.base.body.get("identity"));
		baseBehavior.setCell("activatable",
				runtime.base.body.get("activatable"));
		baseBehavior.setCell("activatable=",
				runtime.base.body.get("activatable="));
		obj.mimicsWithoutCheck(baseBehavior);
		obj.registerCell("BaseBehavior", baseBehavior);

		IokeObject assignmentBehavior = new IokeObject(runtime,
		...
		IokeObject internalBehavior = new IokeObject(runtime,
		...
		IokeObject flowControlBehavior = new IokeObject(runtime,
		...
		IokeObject definitionsBehavior = new IokeObject(runtime,
		...
		IokeObject conditionsBehavior = new IokeObject(runtime,
		...
		IokeObject literalsBehavior = new IokeObject(runtime,
		...
		IokeObject caseBehavior = new IokeObject(runtime,
		...
		IokeObject reflectionBehavior = new IokeObject(runtime,
		...
		IokeObject booleanBehavior = new IokeObject(runtime,
		...
		IokeObject aspects = new IokeObject(runtime,
