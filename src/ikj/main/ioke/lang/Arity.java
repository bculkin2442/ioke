...
public class Arity extends IokeData {
	...
	private static final IokeObject getArity(IokeObject self,
			Taking thing) {
	...
	public static final IokeObject getArity(IokeObject self,
			ArgumentsDefinition def) throws ControlFlow {
	...
	public static final Object takingNothing(IokeObject self)
			throws ControlFlow {
		return self.runtime.arity.getCell(null, null, "taking:nothing");
	}

	public static final Object takingEverything(IokeObject self)
			throws ControlFlow {
	...
	public void init(final IokeObject arity) throws ControlFlow {
		...
		arity.setCell("taking:everything",
				getArity(arity, Taking.Everything));

		arity.registerMethod(arity.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("from") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(arity)
					...
					public Object activate(IokeObject self,
						...
						ArgumentsDefinition def = DefaultArgumentsDefinition
								.createFrom(args, 0, args.size(), message,
										on, context);
		...
		arity.registerMethod(arity.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("positionals") {

					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder()
							.withOptionalPositional("includeOptionals",
									"true")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						if (a.argumentsDefinition != null) {
							for (DefaultArgumentsDefinition.Argument argument : a.argumentsDefinition
									.getArguments()) {
								...
								if (argument instanceof DefaultArgumentsDefinition.OptionalArgument) {
									if (includeOptional) {
										names.add(method.runtime.getSymbol(
												argument.getName()));
									}
								} else {
									names.add(method.runtime.getSymbol(
		...
		arity.registerMethod(arity.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("keywords",
						arity) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
						...
						if (a.argumentsDefinition != null) {
							for (String name : a.argumentsDefinition
									.getKeywords()) {
								names.add(method.runtime.getSymbol(name
		...
		arity.registerMethod(arity.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("krest",
						arity) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		arity.registerMethod(arity.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("rest",
						arity) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		arity.registerMethod(arity.runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("asText",
						arity) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
						...
						return method.runtime.newText(
								a.argumentsDefinition.getCode(false));
					}
				}));
