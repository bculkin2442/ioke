...
public class ReflectionBehavior {
	public static void init(IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod.WithNoArguments("uniqueHexId") {
					...
					public Object activate(IokeObject method,
						...
						return context.runtime.newText("0x" + Integer
				...
				new NativeMethod("same?") {
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						return IokeObject.same(on, args.get(0))
				...
				new NativeMethod("!=") {
					...
					public Object activate(IokeObject method,
						...
						getArguments().getEvaluatedArguments(context,
								message, on, args,
								new HashMap<String, Object>());
						return !IokeObject.equals(on,
								Interpreter.getEvaluatedArgument(message,
										0, context))
												? context.runtime._true
												: context.runtime._false;
					}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("kind?") {
					...
					public Object activate(IokeObject method, Object on,
						...
						return IokeObject.isKind(on, kind, context)
								? context.runtime._true
								: context.runtime._false;
					}
				}));
				...
				new NativeMethod("is?") {
					...
					public Object activate(IokeObject method,
						...
						IokeObject arg = IokeObject.as(args.get(0),
								context);
						return IokeObject.isMimic(on, arg, context)
								? context.runtime._true
								: context.runtime._false;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("removeMimic!") {
					...
					public Object activate(IokeObject method,
						...
						IokeObject.removeMimic(on, args.get(0), message,
								context);
						return on;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("mimic!") {
					private final DefaultArgumentsDefinition ARGUMENTS = DefaultArgumentsDefinition
							.builder().withRequiredPositional("newMimic")
							.getArguments();
					...
					public Object activate(IokeObject method,
						...
						IokeObject newMimic = IokeObject.as(args.get(0),
								context);
						IokeObject.as(on, context).mimics(newMimic,
								message, context);
						return on;
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod("prependMimic!") {
					...
					public Object activate(IokeObject method,
						...
						IokeObject newMimic = IokeObject.as(args.get(0),
								context);
						IokeObject.as(on, context).mimics(0, newMimic,
								message, context);
						return on;
					}
				}));
				...
				new NativeMethod("become!") {
					...
					public Object activate(IokeObject method,
						...
						if (on == context.runtime.nil
								|| on == context.runtime._true
								|| on == context.runtime._false) {
