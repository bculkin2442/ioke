...
public class RegexpMatch extends IokeData {
	...
	public void init(final IokeObject obj) throws ControlFlow {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("target",
						obj) {
					@Override
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("names",
						obj) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("beforeMatch",
						obj) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
						...
						return context.runtime
								.newText(getMatchResult(on).prefix());
					}
				}));

		obj.registerMethod(runtime.newNativeMethod(
				"returns the part of the target after the text that matched",
				new TypeCheckingNativeMethod.WithNoArguments("afterMatch",
						obj) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
							...
							throws ControlFlow {
						return context.runtime
								.newText(getMatchResult(on).suffix());
					}
				}));

		obj.registerMethod(
				runtime.newNativeMethod("returns the text that matched",
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("captures",
						obj) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("asList",
						obj) {
					@Override
					public Object activate(IokeObject method, Object on,
							List<Object> args,
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("start") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(obj)
					...
					public Object activate(IokeObject method, Object on,
						...
						if (args.size() > 0) {
							...
							if (IokeObject.data(arg) instanceof Number) {
								index = Number.extractInt(arg, message,
										context);
							} else {
								String namedIndex = Text
										.getText(Interpreter.send(
												context.runtime.asText,
												context, arg));
								Integer ix = Regexp
										.getRegexp(getRegexp(on))
										.groupId(namedIndex);
								if (ix == null) {
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("end") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(obj)
							.withOptionalPositional("index", "0")
							.getArguments();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("offset") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(obj)
							.withOptionalPositional("index", "0")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						if (index < mr.groupCount()
								&& mr.isCaptured(index)) {
							return context.runtime.newPair(
									context.runtime
											.newNumber(mr.start(index)),
									context.runtime
											.newNumber(mr.end(index)));
				...
				new TypeCheckingNativeMethod("[]") {
					...
					public Object activate(IokeObject method, Object on,
						...
						if ((IokeObject.data(arg) instanceof Symbol)
								|| (IokeObject
										.data(arg) instanceof Text)) {
							String namedIndex = Text.getText(Interpreter
									.send(context.runtime.asText, context,
											arg));
							Integer ix = Regexp.getRegexp(getRegexp(on))
									.groupId(namedIndex);
							...
							if (!(IokeObject
								...
								arg = IokeObject.convertToNumber(arg,
										message, context);
							}
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("pass") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(obj)
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						if (ix == null) {
							...
							condition.setCell("cellName",
									message.runtime.getSymbol(name));
