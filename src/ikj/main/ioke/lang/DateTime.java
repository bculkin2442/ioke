...
public class DateTime extends IokeData {
	...
	public void init(IokeObject obj) throws ControlFlow {
		...
		// obj.mimics(IokeObject.as(runtime.mixins.getCell(null, null,
		// "Comparing")), runtime.nul, runtime.nul);
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.dateTime)
					...
					public Object activate(IokeObject self, Object on,
						...
						return ((other instanceof IokeObject)
								&& (IokeObject
										.data(other) instanceof DateTime)
								&& d.dateTime.equals(((DateTime) IokeObject
										.data(other)).dateTime))
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new NativeMethod.WithNoArguments("now") {
					@Override
					public Object activate(IokeObject method, Object on,
						...
						return method.runtime
								.newDateTime(new org.joda.time.DateTime());
					}
				}));
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("-") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							...
							.whichMustMimic(runtime.dateTime)
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
							...
							IokeObject context, IokeObject message)
							throws ControlFlow {
						long diff = getDateTime(on).getMillis()
								- getDateTime(args.get(0)).getMillis();
		...
		obj.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod.WithNoArguments("inspect",
					...
					public Object activate(IokeObject method, Object on,
							...
							throws ControlFlow {
						return method.runtime
								.newText(DateTime.getInspect(on));
					}
				}));
