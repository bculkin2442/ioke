...
public class Decimal extends IokeData {
	...
	public void init(IokeObject obj) throws ControlFlow {
				...
				new NativeMethod.WithNoArguments("sqrt") {
					...
					public Object activate(IokeObject method,
						...
						return context.runtime.newDecimal(
								new BigSquareRoot().get(value));
					}
				}));

		obj.registerMethod(runtime.newNativeMethod(
				"returns true if the left hand side decimal is equal to the right hand side decimal.",
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(runtime.decimal)
					...
					public Object activate(IokeObject self, Object on,
						...
						return ((other instanceof IokeObject)
								&& (IokeObject
										.data(other) instanceof Decimal)
								&& ((on == runtime.decimal && other == on)
										|| d.value
												.equals(((Decimal) IokeObject
														.data(other)).value)))
		...
		decimal.registerMethod(runtime.newNativeMethod(
		...
		decimal.registerMethod(obj.runtime.newNativeMethod(
		...
		decimal.registerMethod(runtime.newNativeMethod(
				...
				new TypeCheckingNativeMethod("==") {
					private final TypeCheckingArgumentsDefinition ARGUMENTS = TypeCheckingArgumentsDefinition
							.builder().receiverMustMimic(decimal)
							.withRequiredPositional("other")
							.getArguments();
					...
					public Object activate(IokeObject method, Object on,
						...
						if (IokeObject.data(arg) instanceof Number) {
							return (Decimal.value(on).compareTo(
									Number.value(arg).asBigDecimal()) == 0)
											? context.runtime._true
											: context.runtime._false;
						} else if (IokeObject
								.data(arg) instanceof Decimal) {
							return (Decimal.value(on)
				...
				new TypeCheckingNativeMethod("**") {
					...
					public Object activate(IokeObject method, Object on,
						...
						return context.runtime.newDecimal(Decimal.value(on)
								.pow(Number.intValue(arg).intValue()));
					}
				}));
