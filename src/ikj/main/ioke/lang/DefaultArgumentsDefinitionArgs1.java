 ...
 */
public class DefaultArgumentsDefinitionArgs1
	...
	public static List<Object> assign(final IokeObject context,
			final IokeObject message, final Object on, final int expected)
			throws ControlFlow {
		final Runtime runtime = context.runtime;
		...
		while (argCount != expected) {
			...
			if (argCount < expected) {
				...
				condition.setCell("missing",
						runtime.newNumber(expected - argCount));
