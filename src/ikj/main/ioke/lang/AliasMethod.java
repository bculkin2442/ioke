...
public class AliasMethod extends IokeData
	...
	public static Object activateFixed(IokeObject self, IokeObject ctx,
		...
		switch (am.realMethod.type) {
			case IokeData.TYPE_DEFAULT_METHOD:
				return DefaultMethod.activateFixed(realSelf, ctx, message,
						obj);
			case IokeData.TYPE_DEFAULT_MACRO:
				return DefaultMacro.activateFixed(realSelf, ctx, message,
						obj);
			case IokeData.TYPE_DEFAULT_SYNTAX:
				return DefaultSyntax.activateFixed(realSelf, ctx, message,
						obj);
			case IokeData.TYPE_LEXICAL_MACRO:
				return LexicalMacro.activateFixed(realSelf, ctx, message,
						obj);
			case IokeData.TYPE_NATIVE_METHOD:
				return NativeMethod.activateFixed(realSelf, ctx, message,
						obj);
			case IokeData.TYPE_JAVA_CONSTRUCTOR:
				return JavaConstructorNativeMethod.activateFixed(realSelf,
						ctx, message, obj);
			case IokeData.TYPE_JAVA_FIELD_GETTER:
				return JavaFieldGetterNativeMethod.activateFixed(realSelf,
						ctx, message, obj);
			case IokeData.TYPE_JAVA_FIELD_SETTER:
				return JavaFieldSetterNativeMethod.activateFixed(realSelf,
						ctx, message, obj);
			case IokeData.TYPE_JAVA_METHOD:
				return JavaMethodNativeMethod.activateFixed(realSelf, ctx,
						message, obj);
			case IokeData.TYPE_METHOD_PROTOTYPE:
				return Method.activateFixed(realSelf, ctx, message, obj);
			case IokeData.TYPE_LEXICAL_BLOCK:
				return LexicalBlock.activateFixed(realSelf, ctx, message,
						obj);
			case IokeData.TYPE_ALIAS_METHOD:
				return AliasMethod.activateFixed(realSelf, ctx, message,
						obj);
