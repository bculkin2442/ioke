 ...
 * {@link Iterable}, varargs or even a {@link Map}) with a separator. It
 * either appends the results to an {@link Appendable} or returns them as a
 * {@link String}. Example:
 * 
 * <pre>
 *    {@code
 ...
 * </pre>
 *
 * This returns the string {@code "Harry; Ron; Hermione"}. Note that all
 * input elements are converted to strings using {@link Object#toString()}
 * before being appended.
 *
 * <p>
 * If neither {@link #skipNulls()} nor {@link #useForNull(String)} is
 * specified, the joining methods will throw {@link NullPointerException}
...
public class Joiner {
	/**
	 * Returns a joiner which automatically places {@code separator}
	...
	/**
	 * Appends the string representation of each of {@code parts}, using
	 * the previously configured separator between each, to
	 * {@code appendable}.
	 */
	...
	public final <A extends Appendable> A appendTo(A appendable,
			Object[] parts) throws IOException {
		return appendTo(appendable, Arrays.asList(parts));
	}

	/**
	 * Appends to {@code appendable} the string representation of each of
	 ...
	 * {@link #appendTo(Appendable, Object, Object, Object[])}, except that
	 * it does not throw {@link IOException}.
	 */
	public final StringBuilder appendTo(StringBuilder builder,
			Object first, Object second, Object... rest) {
	...
	/**
	 * Returns a string containing the string representation of each
	 * argument, using the previously configured separator between each.
	 */
	...
	/**
	 * Returns a joiner with the same behavior as this one, except
	...
	public Joiner skipNulls() {
		return new Joiner(this) {
			...
			public MapJoiner withKeyValueSeparator(String kvs) {
				checkNotNull(kvs); // weird, just to satisfy
									// NullPointerTester!
				throw new UnsupportedOperationException(
	...
	/**
	 * Returns a {@code MapJoiner} using the given key-value separator, and
	 * the same configuration as this {@code Joiner} otherwise.
	 */
	 ...
	 * {@code Joiner} joins iterables and arrays.
	 */
	public static class MapJoiner {
		...
		/**
		 * Appends the string representation of each entry of {@code map},
		 ...
		 * using the previously configured separator and key-value
		 * separator, to {@code
		 * builder}. Identical to {@link #appendTo(Appendable, Map)},
		...
		/**
		 * Returns a string containing the string representation of each
		 * entry of {@code map}, using the previously configured separator
		 ...
		 * automatically substituting {@code nullText} for any provided
		 * null keys or values.
		 */
		public MapJoiner useForNull(String nullText) {
			return new MapJoiner(joiner.useForNull(nullText),
					keyValueSeparator);
		}
	}
