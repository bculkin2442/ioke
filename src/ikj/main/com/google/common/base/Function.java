...
public interface Function<F, T> {
	 ...
	 * object of type {@code T}. Note that types {@code F} and {@code T}
	 ...
	 * {@code Function}. This method can return {@code true} <i>only</i> if
	 * the specified object is also a {@code Function} and, for every input
	 * object {@code o}, it returns exactly the same value. Thus,
	 * {@code function1.equals(function2)} implies that either
	 * {@code function1.apply(o)} and {@code function2.apply(o)} are both
	 * null, or {@code function1.apply(o).equals(function2.apply(o))}.
	 *
	 * <p>
