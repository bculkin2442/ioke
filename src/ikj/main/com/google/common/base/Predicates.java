...
/**
 * Contains static factory methods for creating {@code Predicate}
 * instances.
 *
 * <p>
...
public final class Predicates {
	...
	/**
	 * Returns a predicate that evaluates to {@code true} if the given
	 ...
	 * components evaluates to {@code true}. The components are evaluated
	 * in order, and evaluation will be "short-circuited" as soon as a
	 * false predicate is found. It defensively copies the iterable passed
	 * in, so future changes to it won't alter the behavior of this
	 * predicate. If {@code
	 ...
	 * components evaluates to {@code true}. The components are evaluated
	 * in order, and evaluation will be "short-circuited" as soon as a
	 * false predicate is found. It defensively copies the array passed in,
	 * so future changes to it won't alter the behavior of this predicate.
	 * If {@code
	 * components} is empty, the returned predicate will always evaluate to
	 * {@code
	 * true}.
	 ...
	 * components evaluates to {@code true}. The components are evaluated
	 * in order, and evaluation will be "short-circuited" as soon as as
	 * soon as a true predicate is found. It defensively copies the
	 * iterable passed in, so future changes to it won't alter the behavior
	 * of this predicate. If {@code
	 * components} is empty, the returned predicate will always evaluate to
	 * {@code
	 * false}.
	 */
	 ...
	 * components evaluates to {@code true}. The components are evaluated
	 * in order, and evaluation will be "short-circuited" as soon as as
	 * soon as a true predicate is found. It defensively copies the array
	 * passed in, so future changes to it won't alter the behavior of this
	 * predicate. If {@code
	 * components} is empty, the returned predicate will always evaluate to
	 * {@code
	 * false}.
	 ...
	 * components evaluates to {@code true}. The components are evaluated
	 * in order, and evaluation will be "short-circuited" as soon as as
	 * soon as a true predicate is found.
	 */
	...
	/**
	 * Returns a predicate that evaluates to {@code true} if the object
	 * being tested {@code equals()} the given target or both are null.
	 */
	...
	/**
	 * Returns a predicate that evaluates to {@code true} if the object
	 * being tested is an instance of the given class. If the object being
	 * tested is {@code null} this predicate evaluates to {@code false}.
	 *
	 * <p>
	...
	/**
	 * Returns a predicate that evaluates to {@code true} if the object
	 * reference being tested is a member of the given collection. It does
	 * not defensively copy the collection passed in, so future changes to
	 * it will alter the behavior of the predicate.
	 *
	 * This method can technically accept any Collection<?>, but using a
	...
	private static class CompositionPredicate<A, B>
		...
		private CompositionPredicate(Predicate<B> p,
		...
		public int hashCode() {
			 ...
			 * calculation should be coordinated with the hashCode() method
			 * of the corresponding composition method in Functions. To
	 ...
	 * specifically, this method returns {@code true} if {@code iterable1}
	 * and {@code iterable2} contain the same number of elements and every
	 * element of {@code iterable1} is equal to the corresponding element
	 * of {@code
	 * iterable2}.
	 *
	 * <p>
	 ...
	 */
	private static boolean iterableElementsEqual(Iterable<?> iterable1,
			Iterable<?> iterable2) {
