...
public class NamedUnit extends Unit implements Externalizable {
	...
	/**
	 * The value of this Unit is scale*base. The value of this.factor is
	 * scale*base.factor, so scale is redundant - were it not for rounding
	 * error concerns.
	 */
	double		scale;
	...
	/**
	 * @serialData Write the unit name (using writeUTF), followed by the
	 *             definition (value) of this unit as a scale followed by a
	 *             base.
	 */
