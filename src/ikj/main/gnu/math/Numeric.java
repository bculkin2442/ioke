...
public abstract class Numeric extends java.lang.Number {
	...
	/**
	 * Return an integer for which of {# code this} or {#code obj} is
	 * larger. Return 1 if {@code this>obj}; 0 if {@code this==obj}; -1 if
	 * {@code this<obj}; -2 if {@code this!=obj} otherwise (for example if
	 * either is NaN); -3 if not comparable (incompatible types).
	 */
	...
	/**
	 * Return this raised to an integer power. Implemented by repeated
	 * squaring and multiplication. If y < 0, returns div_inv of the
	 * result.
	 */
