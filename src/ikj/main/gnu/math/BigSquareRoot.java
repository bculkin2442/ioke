...
/**
 * Taken from public domain implementation found at
 * http://www.merriampark.com/bigsqrt.htm
 */
public class BigSquareRoot {
	private static java.math.BigDecimal	ZERO					= new java.math.BigDecimal(
			"0");
	private static java.math.BigDecimal	ONE						= new java.math.BigDecimal(
			"1");
	private static java.math.BigDecimal	TWO						= new java.math.BigDecimal(
			"2");
	...
	public java.math.BigDecimal get(java.math.BigDecimal n) {
		...
		java.math.BigDecimal guess = new java.math.BigDecimal(
	...
	private static java.math.BigDecimal getInitialApproximation(
