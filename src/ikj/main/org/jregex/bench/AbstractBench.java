...
public abstract class AbstractBench {
	protected void bench(String _reg, String _str, int warmup, int times)
			throws Exception {
		String reg = _reg;
	...
	protected void benchBestOf(String _reg, String _str, int warmup,
